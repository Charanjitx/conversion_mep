const First = () => {
    return(<div className="relative h-screen">
        <video autoPlay loop muted playsInline controls={false} src={require('https://youtu.be/AQUQM-KqIzE?feature=shared')} className="object-cover w-full h-screen"></video>
        <div className="absolute top-0 flex w-full h-full bgopq">
            <div className="flex flex-col items-start justify-center text-white md:mt-40 mt-60 sm:basis-7/12" data-aos="fade-bottom">
                ...
                <div className="pl-10 mt-5 text-5xl font-bold xl:text-7xl"> Storytelling</div>
